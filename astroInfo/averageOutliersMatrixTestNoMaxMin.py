...
while ( ast_ct < maxIn and ast_ct < len(asteroidNames)):
    ...
    while ( attr_ct < len(wanted_attr) ):
        ...
        minSumVal = ( dataSortedByFeature[feature][minIndex + 1] +
                    dataSortedByFeature[feature][minIndex + 2] +
                    dataSortedByFeature[feature][minIndex + 3] )
        maxSumVal = ( dataSortedByFeature[feature][maxIndex - 1] + 
                    dataSortedByFeature[feature][maxIndex - 2] +
                    dataSortedByFeature[feature][maxIndex - 3] )
